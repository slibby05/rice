...
constantFold :: Opt
constantFold _ (lit_primEqChar_ x y)    = (fromBool (x == y), "Constant folding", 0)
constantFold _ (lit_primEqInt_ x y)     = (fromBool (x == y), "Constant folding", 0)
constantFold _ (lit_primEqFloat_ x y)   = (fromBool (x == y), "Constant folding", 0)
constantFold _ (lit_primLtEqChar_ x y)  = (fromBool (x == y), "Constant folding", 0)
constantFold _ (lit_primLtEqInt_ x y)   = (fromBool (x == y), "Constant folding", 0)
constantFold _ (lit_primLtEqFloat_ x y) = (fromBool (x == y), "Constant folding", 0)
constantFold _ (lit_primChr_ x)         = (Lit (Charc (chr x)), "Constant folding", 0)
constantFold _ (lit_primOrd_ x)         = (Lit (Intc (ord x)), "Constant folding", 0)
constantFold _ (lit_primI2F_ x)         = (Lit (Floatc (fromInt x)), "Constant folding", 0)
constantFold _ (lit_primAddInt_ x y)    = (Lit (Intc (x + y)), "Constant folding", 0)
constantFold _ (lit_primSubInt_ x y)    = (Lit (Intc (x - y)), "Constant folding", 0)
constantFold _ (lit_primMulInt_ x y)    = (Lit (Intc (x * y)), "Constant folding", 0)
constantFold _ (lit_primDivInt_ x y)    = (Lit (Intc (div  x y)), "Constant folding", 0)
constantFold _ (lit_primModInt_ x y)    = (Lit (Intc (mod  x y)), "Constant folding", 0)
constantFold _ (lit_primQuotInt_ x y)   = (Lit (Intc (quot x y)), "Constant folding", 0)
constantFold _ (lit_primRemInt_ x y)    = (Lit (Intc (rem  x y)), "Constant folding", 0)
constantFold _ (lit_primAddFloat_ x y)  = (Lit (Floatc (x + y)), "Constant folding", 0)
constantFold _ (lit_primSubFloat_ x y)  = (Lit (Floatc (x - y)), "Constant folding", 0)
constantFold _ (lit_primMulFloat_ x y)  = (Lit (Floatc (x * y)), "Constant folding", 0)
constantFold _ (lit_primDivFloat_ x y)  = (Lit (Floatc (x / y)), "Constant folding", 0)
constantFold _ (lit_primNegateFloat_ x) = (Lit (Floatc (-x)), "Constant folding", 0)
