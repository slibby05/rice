    ...
    while(true)
    {
      ...
      switch(v2_forward.n->symbol->tag)
      {
        ...
        case _char_TAG:
        {
          ...
          field v3_forward = v3;
          v4 = (field)(long)(v3_forward.c);
          field v4_forward = v4;
          set__int(root, v4_forward.i, 0);
          debug(LOW, "leaving ord\n");
          debug_expr(LOW, root);
          return;
        }
    ...
    while(true)
    {
      ...
      switch(v2_forward.n->symbol->tag)
      {
        ...
        case _int_TAG:
        {
          ...
          v3 = child_at(v2_forward, 0);
          field v3_forward = v3;
          v4 = (field)(unsigned long)(v3_forward.i);
          field v4_forward = v4;
          set__char(root, v4_forward.c, 0);
          debug(LOW, "leaving chr\n");
          debug_expr(LOW, root);
          return;
        }
...
// ensureSpine.ensureList.20 at [0]
void Prelude_ensureSpine_DOensureList_DO20__0_hnf(field root)
{
  debug(LOW, "HNF ensureSpine.ensureList.20@[0]\n");
  debug_expr(LOW, root);
  field v2;
  v2 = child_at(root, 0);
  field v2_forward = v2;
    ...
    while(true)
    {
      ...
      switch(v5_forward.n->symbol->tag)
      {
        ...
        case FREE_TAG:
        {
          ...
          push_choice(v5_forward, make_Prelude_False_free());
          set_Prelude_True_free(v5_forward);
          nondet = true;
          break;
        }
        case Prelude_True_TAG:
